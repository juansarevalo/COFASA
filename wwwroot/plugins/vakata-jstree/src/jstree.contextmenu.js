...
(function (factory) {
	...
	$.jstree.defaults.contextmenu = {
		...
		//				// Nueva opción "Centro Cuenta Formato"
		//"centroCuentaFormato": {
		//					"separator_before": true,
		//					"separator_after": false,
		//					"label": "Centro Cuenta Formato",
		//					"action": function (data) {
		//						// Puedes redirigir a la página de "Centro Cuenta Formato" o realizar otra acción.
		//						window.location.href = "/CentroCuentaFormato/Index";
		//					}
					}
				}
			};
